...
export class StackComponent implements OnDestroy {
  ...
  readonly frontendTraits: string[] = [
    'Reativo',
    'Componentizado',
    'Performático',
    'Tipado',
  ...
  readonly levelBadges: Record<number, LevelBadge> = {
    1: {
      label: 'Iniciante',
      cssClass: 'bg-gray-200 text-gray-700 dark:bg-gray-700 dark:text-gray-300',
    },
    2: {
      label: 'Basico',
      cssClass:
    ...
    5: {
      label: 'Expert',
      cssClass: 'bg-dev/15 text-dev dark:bg-dev/25 dark:text-dev-light',
    },
  };
